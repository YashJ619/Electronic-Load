...
const byte ZeroSet = 16;                      //analog pin A2 used as a digital pin to set Zero Readings
...
void loop() {
  ...
  zeroOffset();                                          //check if zero LCD readings selected
